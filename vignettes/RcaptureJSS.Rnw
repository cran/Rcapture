...
\Address{
 Sophie Baillargeon \&   Louis-Paul Rivest \\
  ...
  Québec (Québec), G1K 7P4, Canada\\
    E-mail: \email{sbaillar@mat.ulaval.ca}\\
  E-mail: \email{lpr@mat.ulaval.ca}\\
...
it is not surprising that the best fitting model is heterogenous. Indeed, the model with the
